...
In addition paediatric foetal application are beginning to be explored due to the potential to deliver a non-ionizing energy based therapy, in a non-invasive manner 
	...
	\begin{itemize}
		\item  \textit{Magnetic Resonance acoustic radiation force imaging}  is described in a paper by Bambad Hosseini et al 	\cite{Hosseini2018}.
		\item \textit{Time Reversal Acoustics} is described in a very accessible article for Scientific American by Matthias Fink, \cite{Fink1999}. Put very simply
		- describe what
		A major application is that of lithotripsy, the breaking up of kidney stones, etc....
		Probably not suitable for tumours but for example in avoiding big absorbers such as the ribs  paper \cite{Cochard2009}. 
	\end{itemize}
