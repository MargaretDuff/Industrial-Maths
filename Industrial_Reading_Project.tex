...
\end{equation}
 ...
 \begin{figure}
 	...
 	\caption{A reproduction of the graph prodcued during the study group of temperature profile against time, where there is heating for the first 30sec before the tissue is left to cool}
