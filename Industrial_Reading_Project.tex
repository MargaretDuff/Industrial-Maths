...
\begin{document}
 ...
 Industry  I define it be any non-mathematical institution including: governments, businesses, manufacturers, other academic departments, hospitals, schools, charities etc. 
	...
	The Bond report \cite{Bond} found from its call for evidence a list of the most commonly cited examples of industrial mathematics mechanisms. This included: (NEED MORE EXPLANATION!!!!!!!!!!! NEED TO NOT BE COPIED FROM THE BOND REPORT)
	\begin{itemize}
		\item \textit{Industrial Cooperative Awards in Science and Technology (CASE) PhD studentships }- Businesses take the lead in arranging projects with an academic partner of their choice
		\item \textit{Knowledge Transfer Network Ltd activities }- funded by innovate UK provides innovation network for other funders in line with its mission to drive UK growth 
		\item \textit{Mathematics Study Groups} - Provide a forum for industrial scientists to work alongside academic mathematicians of direct industrial relevance
		\item \textit{Turing gateway to mathematics activities} - impact acceleration initiative 
		\item \textit{Knowledge Transfer Partnerships} - helps businesses in the UK to innovate and grow by linking them with an academic research organisation and a graduate
	\end{itemize}
